...
def equal():
    ...
    try:
        ...
        messagebox.showinfo('Notification','Try again later,Somehing went wrong',parent=screen)    
...
btnsin=Button(screen,text='sin',font=('arial',15,'italic bold'),bd=8,padx=16,pady=19,command=cmsin,activebackground='green',activeforeground='white',bg='powder blue')
btnsin.grid(row=0,column=4)


btncos=Button(screen,text='cos',font=('arial',15,'italic bold'),bd=8,padx=16,pady=19,command=cmcos,activebackground='green',activeforeground='white',bg='powder blue')
btncos.grid(row=1,column=4)


btntan=Button(screen,text='tan',font=('arial',15,'italic bold'),bd=8,padx=18,pady=19,command=cmtan,activebackground='green',activeforeground='white',bg='powder blue')
btntan.grid(row=2,column=4)



btnsqrt=Button(screen,text='sqrt',font=('arial',15,'italic bold'),bd=8,padx=16,pady=19,command=cmsqrt,activebackground='green',activeforeground='white',bg='powder blue')
...
btnsqrt.bind('<Enter>',on_enterlog)
btnsqrt.bind('<Leave>',on_leavelog)
